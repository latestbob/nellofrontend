                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <h2 className="font-weight-normal">Appointment Acknowledgement<br />
                                                {/* <span className="small">#{data?.refrence}</span> */}
                                            </h2>
                                        </div>
                                    </div>
                                </div>
...
export default function AppointmentDone() {
    ...
    return (<div class="content-body container-done appointment">
        {appointment && (<div class="container-width-sm container-done-wrapper">
            ...
            <p className="text-mix-sec">You have scheduled an appointment with
                <span><u> {appointment?.medical_center}</u></span> on
            ...
            <div className="dashed-top-box">
                <div className="flex-space-middle-">
                    <Link to="/account/appointments" class="btn btn-secondary btn-inverse btn-sm" role="button">View Appointments</Link>
