...
export const speakDoc = [
...

  {
    ...
    bot: [
      <div className="incomingMsgWrapMain">
        <p>Great! I’ll connect you to a Doctor Shortly.</p>
      </div>,
      <div className="incomingMsgWrapMain">
        <p>
          {" "}
...

  {
    ...
    bot: [
      <div className="incomingMsgWrapMain">
        <p>
          What type of specialist do you want me help you find?
        </p>
      </div>,
    ],
    botReject: [],
...

  {
    ...
    bot: [
      <div className="incomingMsgWrapMain">
        <p>Please input why you wish to see a doctor.</p>
      </div>,
    ],
    botReject: [],
    type: "bot",
