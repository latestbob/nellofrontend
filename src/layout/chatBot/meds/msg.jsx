...
export const appiontmentMsgs = [
  {
    ...
    user: [
      <div className="ongoingMsgReplyText">
        {" "}
        <p>I’d like to order Medications</p>
      </div>,
    ],
    userReject: [],
    bot: [],
...

  {
    ...
    bot: [
      <div className="incomingMsgWrapMain">
        <p>Great! You can now Order any Medication from Nello Store.</p>
      </div>,
      <div className="incomingMsgWrapMain">
        <p>
          {" "}
      ...
      <div className="incomingMsgWrapMain">
        <p>
          Be rest assured that all drugs on nello store are up to date.
        </p>
      </div>,
    ],
    botReject: [],
